...
##do_runcode
    def do_runcode(self,return_code,fil_ename,magics,code, silent, store_history=True,
        ...
        p = self.create_jupyter_subprocess([fil_ename]+ magics['_st']['args'],cwd=None,shell=False,env=self.addkey2dict(magics,'env'),magics=magics,outencode='GBK')
...
##do_batch_create_codefile
    def do_create_codefile(self,magics,code, silent, store_history=True,
        ...
        source_file=self.create_codetemp_file(magics,code,suffix='.bat')
        newsrcfilename=source_file.name
        fil_ename=newsrcfilename
        return_code=True
